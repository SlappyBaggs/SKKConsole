...
namespace SKKConsoleNS
{
    ...
    public partial class SKKConsoleData : Component
    {
        ...
        public SKKConsoleData(IContainer container)
        {
            ...
            myDefPages.Add(new ConsolePageConfig("Scott1", Color.Lime, new Font("DK Cool Crayon", 17f)));
            myDefPages.Add(new ConsolePageConfig("Bagels", Color.Orange, new Font("Dot 28", 24f)));
            myDefPages.Add(new ConsolePageConfig("DocP", Color.Peru, new Font("Ink Free", 24f)));
        }
        ...
        */
        ...
        public ConsolePageConfigCollection DefaultPages { get => myDefPages; }
    }
}
